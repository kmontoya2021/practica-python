...
def guarda_contraseña():
    paswor= 123
    pasword2 = input("Ingrese la contraseña")

    if pasword2.lower() == paswor.lower(): 
...
def delete_person(id):
    for i in range(len(empleados)):
        if empleados[i]["id"]  == id:
            del empleados[i]
            op = input("Seguro que deseas eliminar")
            print("el registro fué eliminado exitosamente")  
            os.system("PAUSE")           
            return
    print("Empleao no encontrado")
